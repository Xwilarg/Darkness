...
export default class CharacterManager {
    ...
    decrease_player_hp (screen: Screen) {
        ...
        if (hp % 5 === 0) {
            screen.write_narration('You feel darkness consuming your soul a bit more')
        }
        if (hp === 0) {
            screen.write_narration(`You curl up on the ${item('ground')} and close your eyes, trying to feel the last of hope you still have inside you`)
        }
    }
